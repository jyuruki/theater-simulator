...
- `+Y` is elevation.
- The player begins outside the translated main-lobby entrance. V14 retained the concession/office side's established plan-X translation and compact box-office/stair edge while the ticket approach, theater hall, and auditorium modules remained fixed. V15 then translates only the complete Theater 1/2 pair by `+1 m` in plan X toward the ticket podium; both footprints, their shared wall, cubbies, doors, bowls, seating, and internal routes move as one rigid module.
...
- The stair/kiosk side now carries a second original mural based on the newly supplied opposite-lobby view. Its foliage-left, warm-portrait-right composition is deliberately distinct from the concession botanical mural across the lobby. V15 does not move or reshape the V14 concession mural surround, clipped soffit, kitchen roof, two-thirds service wall, connector nook, or sealed floor wedge.
...
- The former future-stair placeholder is realized in V15 as a narrow 2.4-meter lobby stair. A short privacy wall encloses the beginning of the flight; railing opens the remaining run to views across the lobby, and the stair terminates at a closed doorway on the elevated landing. The stair occupies the same compact box-office-side zone rather than widening that side of the lobby.
