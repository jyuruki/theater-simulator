...
def build():
    ...
    box('seat cushion',(0,.52,.005),(.665,.21,.52),'leather',.05)
    back=box('contoured back',(0,.97,-.235),(.665,.82,.15),'leather',.05);back.rotation_euler.x=math.radians(8)
    box('headrest',(0,1.32,-.265),(.645,.17,.12),'leather',.035)
    box('lumbar bolster',(0,.77,-.13),(.635,.17,.12),'leather',.035)
    box('recliner foot pad',(0,.365,.235),(.645,.23,.18),'leather',.035)
